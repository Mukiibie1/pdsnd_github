...
def get_filters():
    ...
    while True:
        month = input(
            "Enter month (valid inputs are:- 'all','january', 'february', 'march', 'april', 'may', 'june') : ").lower()
    ...
    while True:
        day = input(
            "Enter day (valid inputs are:- 'all','monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday') : ").lower()
